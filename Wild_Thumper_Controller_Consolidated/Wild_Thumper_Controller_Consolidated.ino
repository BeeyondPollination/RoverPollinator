...
void setup()
{
  ...
  if(Cmode == 2)
  {
    pinMode(RREncA,INPUT);                                //setting right encoder to a adc input
    digitalWrite(RREncA,HIGH);
    pinMode(RREncB,INPUT);                               
    digitalWrite(RREncB,HIGH);

    pinMode(LREncA,INPUT);                                //setting left encoder to adc input
    digitalWrite(LREncA,HIGH);
    pinMode(LREncB,INPUT);                                
    digitalWrite(LREncB,HIGH);
  }
  else if (Cmode==1) 
  {
